...
import org.springframework.boot.SpringApplication;            // Main class to run Spring Boot applications
import org.springframework.boot.autoconfigure.SpringBootApplication; // Annotation for Spring Boot apps
import org.springframework.context.annotation.ComponentScan; // Annotation for component scanning
