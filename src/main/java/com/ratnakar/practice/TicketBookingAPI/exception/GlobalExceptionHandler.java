...
import org.springframework.http.HttpStatus;  // Enum containing HTTP status codes (200 OK, 404 NOT FOUND, etc.)
import org.springframework.http.ResponseEntity;  // Spring class representing entire HTTP response
// Spring Web annotations for global exception handling
import org.springframework.web.bind.annotation.ExceptionHandler;  // Annotation to mark method as exception handler
